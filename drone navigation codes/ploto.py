...
data_file0 = "data1.txt"  # Replace with your actual file paths
data_file1 = "data2.txt"
data_file2 = "data8.txt"
...
x_interp = np.linspace(min(x), max(x), 10)  # Increase the number of points for a smoother curve
...
plt.plot(data0, marker='o', label='Data 1')
y_pad = 1.0
...
plt.subplot(312)  # Three rows, one column, third subplot
plt.plot(data1, marker='o', label='Data 2')
y_pad = 1.0
