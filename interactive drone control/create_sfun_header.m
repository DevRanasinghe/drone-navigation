...
if length(simulink_bus_name)==length('mavlink_set_position_target_local_ned_t')
    if simulink_bus_name == 'mavlink_set_position_target_local_ned_t'
        mavlink_msg_name = 'set_position_target_local_ned';
    else
        mavlink_msg_name = erase(simulink_bus_name,{'mavlink_','_t'});
    end
elseif length(simulink_bus_name)==length('mavlink_set_attitude_target_t')
    if simulink_bus_name == 'mavlink_set_attitude_target_t'
        mavlink_msg_name = 'set_attitude_target';
    else
        mavlink_msg_name = erase(simulink_bus_name,{'mavlink_','_t'});
    end
else
